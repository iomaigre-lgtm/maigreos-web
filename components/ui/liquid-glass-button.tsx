...
function LiquidButton({
  ...
  return (
    <Comp
      ...
      {...props}
    >
      <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full shadow-[0_0_6px_rgba(0,0,0,0.03),0_2px_6px_rgba(0,0,0,0.08),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.5),inset_-1px_-1px_1px_-0.5px_rgba(255,255,255,0.4),inset_0_0_6px_6px_rgba(255,255,255,0.07),inset_0_0_2px_2px_rgba(255,255,255,0.04),0_0_12px_rgba(255,255,255,0.05)] transition-all" />
      <div
